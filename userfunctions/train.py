...
if __name__ == '__main__':
    ...
    train_model(model = model, dataloaders = dataloaders, use_cuda = use_cuda, optimizer = optimizer, num_epochs = args.epochs,
        ...
        loss_criterion = args.loss_criterion, trained_epochs = trained_epochs, freeze_epochs = args.freeze_e, tb_writer = writer, training_metrics_path = training_metrics_path )
